...
'''
    ...
    Added: aux origin, svg output & merging
'''
...
# just makes sense
plot_plan = [
    ( Edge_Cuts, "1-Edge_Cuts",   "Edges",        "yellow" ),

    ( F_SilkS,   "2-SilkTop",     "Silk top",     "lightblue" ),
    ( F_Paste,   "3-PasteTop",    "Paste top",    None ),
    ( F_Cu,      "4-CuTop",       "Top layer",    "red" ),
    ( F_Mask,    "5-MaskTop",     "Mask top",     None ),

    ( B_Mask,    "6-MaskBottom",  "Mask bottom",  None ),
    ( B_Cu,      "7-CuBottom",    "Bottom layer", "blue" ),
    ( B_Paste,   "8-PasteBottom", "Paste Bottom", None ),
    ( B_SilkS,   "9-SilkBottom",  "Silk bottom",  "magenta" ),
]


for layer_info in plot_plan:
    pctl.SetLayer(layer_info[0])
    pctl.OpenPlotfile(layer_info[1], PLOT_FORMAT_SVG, layer_info[2])
    pctl.PlotLayer()
